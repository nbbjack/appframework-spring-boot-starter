...
import com.framework.authority.properties.OAuth2ClientProperties;
        ...
        if (ArrayUtils.isNotEmpty(securityProperties.getOauth2().getClients())) {
            for (OAuth2ClientProperties c : securityProperties.getOauth2().getClients()) {
                builder
                    ...
                    // refresh_token有效期
                    .refreshTokenValiditySeconds(c.getRefreshTokenValiditySeconds()).redirectUris(c.getRedirectUris())
                    // 客户单权限
                    .scopes(c.getScopes())
                    // 授权模式
