...
import com.framework.authority.properties.SecurityProperties;
...
public class TokenStoreConfig {
    ...
    /**
     * matchIfMissing ：当tokenStore没有值的时候是否生效 当tokenStore = jwt的时候或则tokenStore没有配置的时候使用下面的配置
     */
    @Configuration
    @ConditionalOnProperty(prefix = "framework.security.oauth2", name = "tokenStore", havingValue = "jwt",
        matchIfMissing = true)
