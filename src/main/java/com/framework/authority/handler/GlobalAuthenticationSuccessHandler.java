...
public class GlobalAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public GlobalAuthenticationSuccessHandler(AuthorizationServerTokenServices authorizationServerTokenServices,
        ClientDetailsService clientDetailsService, BCryptPasswordEncoder passwordEncoder) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        // 构建TokenRequest 参数：requestParameters 不同的授权模式有不同的参数 String grantType 自定义
        TokenRequest tokenRequest =
            new TokenRequest(MapUtils.EMPTY_SORTED_MAP, clientId, clientDetails.getScope(), "costom");
