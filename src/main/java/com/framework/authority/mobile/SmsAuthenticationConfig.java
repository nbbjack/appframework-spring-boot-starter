...
/**
 * 短信登录配置类 将自定义Filter与Provider串起来，加入到spring security的整个过滤器链中
 * 
 * @author nbbjack
 */
public class SmsAuthenticationConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        authenticationFilter.setAuthenticationSuccessHandler(new GlobalAuthenticationSuccessHandler(
            authorizationServerTokenServices, clientDetailsService, passwordEncoder));
        // 登录失败处理
        ...
        httpSecurity.authenticationProvider(smsAuthenticationProvider).addFilterAfter(authenticationFilter,
